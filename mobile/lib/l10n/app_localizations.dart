...
abstract class AppLocalizations {
  ...
  /// No description provided for @homePrivacyMessage.
  ///
  /// In en, this message translates to:
  /// **'Private assistance, under your control.'**
  String get homePrivacyMessage;
  ...
  /// No description provided for @replyLanguageLabel.
  ///
  /// In en, this message translates to:
  /// **'Agent reply language'**
  String get replyLanguageLabel;

  /// No description provided for @replyLanguageHelp.
  ///
  /// In en, this message translates to:
